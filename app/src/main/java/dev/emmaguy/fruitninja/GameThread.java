...
public class GameThread implements Runnable {
    ...
    private final Paint posPaint = new Paint();
    ...
    private double[] latestPoint = new double[2];
    ...
    public void startGame(int width, int height) {
        ...
        this.posPaint.setColor(Color.BLUE);
        this.posPaint.setStrokeWidth(10.0f);
    }
                    ...
                    if (canvas != null) {
                        synchronized (surfaceHolder) {
                            ...
                            if (paths != null) {
                                ...
                                // yichao
                                canvas.drawCircle((float)latestPoint[0], (float)latestPoint[1], 10, posPaint);
                            }
    ...
    public void updateDrawnPath(SparseArrayCompat<TimedPath> paths, double []points) {
        this.paths = paths;
        this.latestPoint[0] = points[0];
        this.latestPoint[1] = points[1];
    }
}